...
export default class DoctorsHeader extends Component {
  render() {
    let headers = (__APPID__.trim() === 'naaf87561') ? ['Name', 'Age, Gender', 'Will meet with', 'Type of Alopecia Areata', 'Contact'] : ['Badge', 'Name', 'Type of Practice', 'Payment options', 'Contacts'];
    return (
